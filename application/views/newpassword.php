...
<body style="width:320px;margin:50px auto 20px auto;background-color:#eee;">
    ...
    <div class="w3-card w3-white w3-text-grey">
        <div class="w3-container" style="padding: 25px;">
            <form method="post">
                <input type="hidden" value="<?php echo $unikid ?>" name="unikid"/>
                <input type="hidden" value="<?php echo $username ?>" name="username"/>
                <p>
                    <label>New Password</label>
                    <input type="password" name="new" class="w3-input w3-border" required/>
                </p>
                <p>
                    <label>Confirm Password</label>
                    <input type="password" name="confirm" class="w3-input w3-border" required/>
                </p>
                <p>
                    <button type="submit" formaction="<?php echo site_url('auth/createpassword') ?>" class="w3-button w3-block w3-blue">Create New Password</button>
                </p>
            </form>
        </div>
    </div>
