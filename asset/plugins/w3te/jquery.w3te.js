 ...
 * W3CSS Text Editor
 * v0.0.1
 * Copyright (C) 2018, Tedir Ghazali (tedirghazali@gmail.com)
...
*/
(function(e){
	e.fn.w3te=function(t){
		function f(e,t,n,r,i){
			var s=a.length+1;
			return a.push({
				name:e,cls:s,command:t,key:n,tag:r,emphasis:i
			})
		}
		var n=[
			{title:"Font Size"},
		...
		var o=e.extend({
			css:"w3te",title:true,titletext:n,button:"OK",fsize:true,fsizes:r,funit:"px",color:true,linktypes:s,b:true,i:true,u:true,ol:true,ul:true,sub:true,sup:true,outdent:true,indent:true,left:true,center:true,right:true,strike:true,link:true,unlink:true,remove:true,rule:true,source:true
		},t);
		...
		return this.each(function(){
			...
			function _(t,n,r){
				...
				if(window.getSelection){
					...
					var f=a.htmlText;var l="<"+t+" "+n+'="'+r+'">'+f+"</"+t+">";
			...
			function H(e,t){
				...
				if(n&&!t){
					...
					var r=t.split(";");r=r[0].split(":");e.find("*").css(r[0],r[1])
				}
			}function B(){
				if(!f.data("sourceOpened")){
					var t=D();var n="http://";F(true);
					if(t){var r=t.prop("tagName").toLowerCase();
					if(r=="a"&&t.is("[href]")){
						n=t.attr("href");t.attr(y,"")
						}else{
							_("a",y,"")
						}
					}else d.val(n).focus();
			...
			function j(t){
				d.focus();
				P(t);t.removeAttr(y);
				if(m.data("linktype")!="2")M("createlink",d.val());
				else{
					M("insertImage",d.val());c.find("img").each(function(){
						var t=e(this).prev("a");var n=e(this).next("a");
						if(t.length>0&&emptyLinks.html()=="")t.remove();
			...
			function F(e){
				...
				if(e){f.data("linkOpened",true);
				l.slideDown(100)}else{f.data("linkOpened",false);
				l.slideUp(100)}I()
			}
			function I(e){
				if(e)m.stop(true,true).delay(100).slideToggle(100);
				else m.stop(true,true).delay(100).slideUp(100)
			}
			function q(e){
				var t=m.data("linktype");
				if(t=="1"&&(d.val()=="http://"||d.is("[value^=http://]")||!d.is("[value^=mailto]")))d.val("mailto:");
				else if(t!="1"&&!d.is("[value^=http://]"))d.val("http://");
				else d.val(e)
			}
			function R(t){
				if(!f.data("sourceOpened")){
					if(t=="fSize")styleField=L;
					else if(t=="colors")styleField=A;U(styleField,true);
					styleField.find("a").click(function(){
						var n=e(this).attr(o.css+"-styleval");
						if(t=="fSize"){
							styleType="font-size";n=n+o.funit
						}else if(t=="colors"){
							styleType="color";n="rgb("+n+")"
						}
						var r=W(styleType);
						_("span","style",styleType+":"+n+";"+r);
						U("",false);e("."+o.css+"_title").remove();
						V()
					})
			...
			var r=e(this).is("[name]")?' name="'+e(this).attr("name")+'"':"";t.after('<div class="'+o.css+'" ></div>');
			var s=t.next("."+o.css);s.html('<div class="'+o.css+"_toolbar"+' w3-bar w3-light-grey" style="border-bottom:1px solid #aaa;" role="toolbar" unselectable></div><div class="'+o.css+'_linkform" style="display:none" role="dialog"></div><div class="'+o.css+"_editor"+'"></div>');
			...
			for(var E=0;E<a.length;E++){
				if(o[a[E].name]){
					...
					var x=o.titletext[E].title!=null&&o.titletext[E].title!="undefined"&&o.titletext[E].title!=""?o.titletext[E].title+S:"";f.append('<div class="'+o.css+"_tool "+o.css+"_tool_"+a[E].cls+' w3-button" role="button" data-tool="'+E+'" unselectable><a class="'+o.css+'_tool_icon" unselectable></a></div>');f.find("."+o.css+"_tool[data-tool="+E+"]").data({tag:a[E].tag,command:a[E].command,emphasis:a[E].emphasis,title:x});
					if(a[E].name=="fsize"){
			...
			var C="";
			if(/msie/.test(u))C="-ms-";
			else if(/chrome/.test(u)||/safari/.test(u)||/yandex/.test(u))C="-webkit-";
			else if(/mozilla/.test(u))C="-moz-";
			else if(/opera/.test(u))C="-o-";
			else if(/konqueror/.test(u))C="-khtml-";
			s.find("[unselectable]").css(C+"user-select","none").attr("unselectable","on").on("selectstart mousedown",function(e){e.preventDefault()});
			...
			k.click(function(n){
				...
				if(o.title&&e(this).data("title")!=""&&(e(t.target).hasClass(o.css+"_tool")||e(t.target).hasClass(o.css+"_tool_icon"))){
					...
					var a=i.top+e(this).outerHeight()+5;n.delay(400).css({top:a,left:u}).fadeIn(200)
				}
			},function(){
				e("."+o.css+"_title").remove()
			});
				...
				if(e.ctrlKey){
					for(var t=0;t<a.length;t++){
						if(o[a[t].name]&&e.keyCode==a[t].key.charCodeAt(0)){
							if(a[t].command!=""&&a[t].command!="linkcreator")M(a[t].command,null);
							else if(a[t].command=="linkcreator")B();
							return false
						}
					}
				}
